...
const ContactSentModal: FC<{
  setShowModal: Dispatch<SetStateAction<boolean>>;
  sendSuccess: boolean;
}> = ({ setShowModal, sendSuccess }): JSX.Element => {
  return sendSuccess ? (
    <>
        ...
        <div className="relative w-5/6 md:w-auto my-6 mx-auto max-w-3xl">
          <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
            ...
            <div className="relative p-6 mb-8 flex-auto text-center flex flex-col items-center">
              <img
                src="/feedback/checkmark.svg"
                alt="checkmark"
                className="w-28 my-8"
              />
              <p className="my-4 text-blueGray-500 text-lg leading-relaxed font-thin">
                Thank you for your contact. <br /> I'll get back to you as soon
                as possible!
              </p>
            </div>
