				...
				<Fade right>
					{dotValue === 0 ? (
						<div className="w-1/2 flex flex-col justify-center items-center bg-tertiary rounded-xl ml-8">
							...
							<p className="font-thin m-8 text-xl text-secondary max-h-60 overflow-auto">
						...
						<div className="w-1/2 flex flex-col justify-center items-center bg-tertiary rounded-xl ml-8">
							...
							<p className="font-thin m-8 text-xl text-secondary max-h-60 overflow-auto">Angular course</p>
						</div>
					) : dotValue === 3 ? (
						<div className="w-1/2 flex flex-col justify-center items-center bg-tertiary rounded-xl ml-8">
							<img src="/html.svg" alt="html" className="h-20 w-20 mb-2.5" />
							<p className="font-thin m-8 text-xl text-secondary max-h-60 overflow-auto">HTML and CSS course</p>
						</div>
					) : dotValue === 4 ? (
						<div className="w-1/2 flex flex-col justify-center items-center bg-tertiary rounded-xl ml-8">
							<img src="/javascript.svg" alt="javascript" className="h-20 w-20 mb-2.5" />
							<p className="font-thin m-8 text-xl text-secondary max-h-60 overflow-auto">Javascript course</p>
						</div>
					) : dotValue === 5 ? (
						<div className="w-1/2 flex flex-col justify-center items-center bg-tertiary rounded-xl ml-8">
							<img src="/node.svg" alt="node" className="h-20 w-20 mb-2.5" />
							<p className="font-thin m-8 text-xl text-secondary max-h-60 overflow-auto">Node course</p>
						</div>
					) : dotValue === 6 ? (
						<div className="w-1/2 flex flex-col justify-center items-center bg-tertiary rounded-xl ml-8">
							<img src="/react.svg" alt="react" className="h-20 w-20 mb-2.5" />
							<p className="font-thin m-8 text-xl text-secondary max-h-60 overflow-auto">React course</p>
						</div>
					) : dotValue === 7 ? (
						<div className="w-1/2 flex flex-col justify-center items-center bg-tertiary rounded-xl ml-8">
							<img src="/react.svg" alt="react" className="h-40 w-40 mb-2.5" />
							<ul className="font-thin m-8 text-base text-secondary max-h-68 overflow-auto list-inside list-disc max-h-80">
						...
						<div className="w-1/2 flex flex-col justify-center items-center bg-tertiary rounded-xl ml-8">
							<img src="/node.svg" alt="node" className="h-20 w-20 mb-2.5" />
							<p className="font-thin m-8 text-xl text-secondary max-h-60 overflow-auto">Advanced node course</p>
						</div>
					)}
				</Fade>
			</div>
